...
import { ArrowLeft, ChevronDown, ImagePlus, Loader2, Save, X } from 'lucide-react';
    ...
    getEvent(id)
      .then((ev) => {
        ...
        if (ev.cover_image_position) {
          const [px, py] = ev.cover_image_position
            .split(' ')
            .map((v) => parseInt(v));
    ...
    try {
      const payload = {
        ...
        max_file_size_mb: values.max_file_size_mb
          ? Number(values.max_file_size_mb)
          : null,
        ...
        >
            ...
            <div className='space-y-4'>
              <div>
                ...
                <input
                  ...
                  className='w-full rounded-xl border border-[#272F54]/15 bg-white/80 px-4 py-2 text-sm text-[#272F54] placeholder-[#272F54]/30 outline-none focus:border-[#83BDE5] focus:ring-2 focus:ring-[#83BDE5]/20'
                  placeholder='ex. Workshop Python pentru studenți'
                />
                {errors.title && (
                  <p className='mt-1 text-xs text-[#FF8383]'>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className='w-full rounded-xl border border-[#272F54]/15 bg-white/80 px-4 py-2 text-sm text-[#272F54] placeholder-[#272F54]/30 outline-none focus:border-[#83BDE5] focus:ring-2 focus:ring-[#83BDE5]/20 resize-none'
              ...
              <div>
                ...
                <div className='relative'>
                  <select
                    ...
                    className='w-full appearance-none rounded-xl border border-[#272F54]/15 bg-white/80 pl-4 pr-9 py-2 text-sm text-[#272F54] outline-none focus:border-[#83BDE5] focus:ring-2 focus:ring-[#83BDE5]/20'
                  >
            ...
            <div className='grid gap-4 sm:grid-cols-2'>
              <div>
                ...
                <input
                  ...
                  className='w-full rounded-xl border border-[#272F54]/15 bg-white/80 px-4 py-2 text-sm text-[#272F54] outline-none focus:border-[#83BDE5] focus:ring-2 focus:ring-[#83BDE5]/20'
                />
                {errors.starts_at && (
                  <p className='mt-1 text-xs text-[#FF8383]'>
          ...
          <section className='glass-card rounded-3xl p-6'>
            ...
            <p className='text-xs text-slate-500 mb-4'>
              Opțional — dacă nu specifici, se aplică limitele globale.
            </p>
            <div className='grid gap-4 sm:grid-cols-2'>
              <div>
                <label className='block text-xs font-semibold uppercase tracking-wider text-[#272F54]/60 mb-1'>
          ...
          <div className='flex justify-end gap-3 pb-10'>
            <Link
              to='/organizator/evenimente'
              className='rounded-2xl border border-[#272F54]/20 bg-white px-6 py-2 text-sm font-semibold text-[#272F54] transition hover:border-[#272F54]/40'
            >
              Anulează
            </Link>
            <button
              ...
              className='inline-flex items-center gap-2 rounded-2xl bg-[#272F54] px-6 py-2 text-sm font-semibold text-white shadow transition hover:bg-[#1e2544] disabled:opacity-60'
            >
              {isSubmitting ? (

      ...
      <main className='mx-auto max-w-6xl px-4 py-10'>
        ...
        >
          ...
          <p className='mt-1 text-sm text-slate-600'>
            Evenimentele de mai jos au fost trimise de organizatori și așteaptă
            aprobarea ta.
          </p>
        </motion.div>
                    ...
                    <div className='flex flex-col gap-4 sm:flex-row sm:items-start'>
                      ...
                      <div className='flex-1 min-w-0'>
                        <div className='flex flex-wrap gap-2 items-center'>
                          ...
                          <span className='inline-flex items-center justify-center rounded-full bg-[#FFF574]/60 px-2.5 py-0.5 text-xs font-semibold text-amber-800'>
                            În așteptare
                          </span>
                      ...
                      <div className='flex flex-shrink-0 gap-2 sm:flex-col'>
                        <motion.button
                          ...
                          className='inline-flex items-center gap-2 rounded-2xl bg-[#A1D6CB] px-5 py-2 text-sm font-semibold text-teal-900 shadow transition hover:bg-[#8dc5ba] disabled:opacity-50'
                        >
                          {busy === event.id ? (
                        ...
                        <motion.button
                          ...
                          className='inline-flex items-center gap-2 rounded-2xl bg-[#FF8383]/20 px-5 py-2 text-sm font-semibold text-rose-800 border border-[#FF8383]/40 transition hover:bg-[#FF8383]/30 disabled:opacity-50'
                        >
          ...
          >
            ...
            >
              ...
              <textarea
                ...
                className='w-full rounded-xl border border-[#272F54]/15 bg-slate-50 px-4 py-2 text-sm text-[#272F54] outline-none focus:border-[#FF8383] focus:ring-2 focus:ring-[#FF8383]/20 resize-none'
              />

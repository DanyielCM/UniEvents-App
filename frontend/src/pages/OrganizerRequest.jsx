...
const ORGANIZER_TYPES = [
  ...
  {
    value: 'external_individual',
    label: 'Organizator extern – persoană fizică',
  },
];
      ...
      <div className='relative z-10 mx-auto max-w-3xl px-4 py-8 sm:py-12'>
        ...
        {success ? (
          ...
          >
            ...
            <Link
              to='/'
              className='mt-6 inline-flex items-center justify-center rounded-2xl bg-[#272F54] px-5 py-2 text-sm font-semibold text-white transition hover:bg-[#1e2544]'
            >
          ...
          >
            ...
            <div className='grid gap-5 sm:grid-cols-2'>
              ...
              <Field label='Nume' icon={User} error={errors.last_name?.message}>
                <input
                  type='text'
...
const inputClass =
  'w-full rounded-xl border border-slate-200 bg-white/80 py-2 pl-10 pr-3 text-sm text-[#272F54] placeholder:text-slate-400 shadow-sm transition focus:border-[#83BDE5] focus:outline-none focus:ring-2 focus:ring-[#83BDE5]/40';

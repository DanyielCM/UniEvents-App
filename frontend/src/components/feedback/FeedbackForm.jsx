  ...
  if (done) {
    return (
      ...
      >
        ...
        <span>
          Mulțumim pentru feedback! {'★'.repeat(rating)}
          {'☆'.repeat(5 - rating)}
        </span>
      </motion.div>
    );
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className='inline-flex items-center gap-2 rounded-xl bg-[#272F54] px-5 py-2 text-sm font-semibold text-white transition hover:bg-[#1e2544] disabled:opacity-50'
      >
